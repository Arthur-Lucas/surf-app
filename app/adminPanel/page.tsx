    ...
    <main className="min-h-screen w-full bg-white text-black p-10 flex items-center justify-center">
      <div className="w-full max-w-3xl space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div>
            <Label className="py-4" htmlFor="location">
              Pays
            </Label>
            <Input
              name="location"
          ...
          <div>
            <Label className="py-4" htmlFor="waveType">
              Type de vague
            </Label>
            <Input
              name="waveType"
          ...
          <div>
            <Label className="py-4" htmlFor="difficulty">
              Difficulté
            </Label>
            <Input
              name="difficulty"
          ...
          <div>
            <Label className="py-4" htmlFor="lat">
              Latitude
            </Label>
            <Input name="lat" value={formData.lat} onChange={handleChange} />
          </div>
          <div>
            <Label className="py-4" htmlFor="lng">
              Longitude
            </Label>
